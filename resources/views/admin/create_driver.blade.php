...
<div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-md">
    ...
    <form action="{{ route('admin.storeDriver') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
        @csrf
        ...
        <div>
            ...
            <input type="text" name="jabatan" class="w-full border-gray-300 rounded-lg p-2" value="Driver">
        </div>
